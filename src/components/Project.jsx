...
const Project = (props) => {
  return (
    <div className="overflow-hidden aspect-video bg-red-400 cursor-pointer rounded-xl relative group w-80 h-52">
      <div className="rounded-xl z-10 md:opacity-0 group-hover:opacity-100 transition duration-300 ease-in-out cursor-pointer absolute from-[#000] to-transparent bg-gradient-to-t inset-x-0 -bottom-2 pt-30 text-white flex items-end">
        <div className='w-full'>
          <div className="transform-gpu p-4 space-y-3 text-xl group-hover:opacity-100 group-hover:translate-y-0 translate-y-4 pb-10 transform transition duration-300 ease-in-out w-full">
            <div className="font-bold w-full">{props.title}</div>
