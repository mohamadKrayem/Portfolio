    ...
    <footer className='col-center mt-16 md:w-auto w-80'>
      <div className="flex flex-wrap justify-center gap-12 w-[90%]">
        <div className='lg:basis-1/3 w-full md:w-auto text-start'>
          ...
          <p className='font-["Poppins"] text-xl text-skin-fourth leading-9 mb-6'>I'm a Lebanese student. Writing readable, reusable, clean code is my goal in my work, helping people is my passion in life. My first rule is that getting to know someone new is never a loss.</p>
        ...
        <div className='lg:basis-1/3 w-full md:w-auto text-start'>
          ...
          <div className="flex items-center gap-2">
            ...
            <p className='font-["Poppins"] text-xl text-skin-fourth mb-2'>+961 3 639 845</p>
          </div>
          <div className="flex items-center gap-2">
      ...
      <p className="md:text-2xl sm:text-xl  my-10 text-skin-fourth">Copyright &copy; 2022 all rights reserved</p>
